...
import {BackHandler, SafeAreaView, Text, View, Alert} from 'react-native';
...
// Test chart data for iOS debugging
const testChartData = {
...
const testPieChartData = {
  ...
  payload: {
    text: 'iOS Pie Chart Test',
    elements: [
      { title: 'iOS', value: 45 },
      { title: 'Android', value: 35 },
      { title: 'Web', value: 20 }
    ]
  }
};
...
class Home extends React.Component<HomeProps, homeState> {
  ...
  // Test chart rendering - use this data format for bot responses
  testChart = () => {
    Alert.alert('Chart Test', 'Check console for chart data format. Send a message with chart template_type to test.');
    console.log('Test Chart Data:', JSON.stringify(testChartData, null, 2));
  };
